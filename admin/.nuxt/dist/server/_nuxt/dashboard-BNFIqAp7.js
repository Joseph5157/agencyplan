...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><div class="flex flex-col gap-1"><h2 class="text-2xl font-semibold tracking-tight">Welcome, ${ssrInterpolate(unref(welcomeName))}</h2><p class="text-sm text-slate-600">${ssrInterpolate(unref(schoolName))} · School ID: ${ssrInterpolate(unref(schoolId))}</p></div>`);
...
//# sourceMappingURL=dashboard-BNFIqAp7.js.map
